...
function DialogOverlay({ className, ...props }: DialogPrimitive.Backdrop.Props) {
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-slate-900/10 transition-opacity duration-150",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "max-w-md",
          // Visual
          "flex flex-col rounded-2xl border border-white/60 bg-white/30 backdrop-blur-2xl shadow-2xl shadow-slate-300/40",
          // Animation
